...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAllDepartments", function() { return getAllDepartments; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showDepartmentOptions", function() { return showDepartmentOptions; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__userCard__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__departmentOptions__ = __webpack_require__(3);
...
function getAllUsers() {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.get("/user").then(showAllUsers);
}

function showAllUsers(data) {
  let counter = 0;
  for (let user of data.users) {
    const card = new __WEBPACK_IMPORTED_MODULE_1__userCard__["a" /* default */](user);
...
function getSingleUser(userId) {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.get(`/user/${userId}`).then(showSingleUser);
}

function showSingleUser(data) {
  const card = new __WEBPACK_IMPORTED_MODULE_1__userCard__["a" /* default */](data);
  card.renderSingleUserProfile(".main");
  card.renderUserLink(".edit-link-containter");
}

function createUser() {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.post(`/user/`);
}

function editUser(userId) {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.post(`/user/${userId}`);
}

function getSingleUserEdit(userId) {
  return __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.get(`/user/${userId}`).then(showSingleUserEdit);
}
...
function getAllDepartments(selectDepartmentId) {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.get("/department").then(data => {
...
function showDepartmentOptions(data, selectDepartmentId) {
  ...
  for (let department of data.departments) {
    const departmentModel = new __WEBPACK_IMPORTED_MODULE_2__departmentOptions__["a" /* default */](department);
    counter++;
...
function captureUserSubmission() {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#profile-form").on("submit", function(e) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
      url: "/user/",
      type: "POST",
      data: __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#profile-form").serialize(),
...
(function(window) {
  ...
  entryPoints.runProfile = () => {
    let queries = {};
    __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.each(document.location.search.substr(1).split("&"), function(c, q) {
      let i = q.split("=");
...
class UserCard {
  ...
  setHandlers(itemToClick) {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(itemToClick).on("click", ".profile-card", function(event) {
      event.preventDefault();
      window.location = `profile.html?id=${__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr("data-userId")}`;
    });
  }

  renderUserCard(containerForAppending) {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(containerForAppending).prepend(`
  ...
  renderSingleUserProfile(containerForAppending) {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(containerForAppending).append(`
            ...
            <fieldset>
              ...
              <div>
                ...
                <select id="departmentName" name="departmentName">
                 ${Object(__WEBPACK_IMPORTED_MODULE_1__index__["getAllDepartments"])(this.user.departmentId)}
                </select>
              </div>
              <section class="flex-container">
                <div>
...
class DepartmentOptions {
  ...
  renderDepartmentOptions(
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(containerForAppending).append(renderString);
  }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = DepartmentOptions;
