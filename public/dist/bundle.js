...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__userCard__ = __webpack_require__(1);
...
class UserCard {
  ...
  setHandlers() {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".profile-container").hover(() => {
      // do the flippy thang
    });

    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".profile-container").click(() => {
      // go to page
    });
  }

  render(conatinerIndentifier) {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(conatinerIndentifier).append(`
